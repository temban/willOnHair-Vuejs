          ...
          >
            ...
            <div v-else class="avatar-upload">
              ...
              <div class="avatar-preview">
                <img
                  :src="
                    'https://willonhair.shintheo.com/api/v1/image/res.partner/' +
                    profile +
                    '/image_1920?unique=true&filename_field=name&file_response=true'
                  "
                  style="
                    border-radius: 160px;
...
export default defineComponent({
  ...
  mounted() {
    ...
    let config3 = {
      ...
      maxBodyLength: Infinity,
      url:
        "https://willonhair.shintheo.com/api/res.partner/" +
        localStorage.getItem("current_user_partnerId"),
      headers: {
        "api-key": "NMMAG3K4IVS0L6VYEPXLJ1Z0RR77AR67",
      },
    };
  ...
  methods: {
    handleFileUpload(e) {
      ...
      let config = {
        ...
        maxBodyLength: Infinity,
        url:
          "https://willonhair.shintheo.com/api/v1/upload/res.partner/" +
          localStorage.getItem("current_user_partnerId") +
          "/image_1920",
        headers: {
