...
class LayoutService {
  ...
  public static enableToolbar(): void {
    config.value.toolbar.display = true;

    // Enable Sidebar
    this.bodyStore.addBodyClassname("toolbar-enabled");
  }

  public static disableToolbar(): void {
    config.value.toolbar.display = false;

    // Enable Sidebar
    this.bodyStore.removeBodyClassName("toolbar-enabled");
  }
